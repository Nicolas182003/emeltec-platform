...
async function seed() {
  try {
    ...
    await db.query(`ALTER TABLE usuario ADD COLUMN IF NOT EXISTS otp_hash VARCHAR(255);`);
    await db.query(`ALTER TABLE usuario ADD COLUMN IF NOT EXISTS otp_expires_at TIMESTAMPTZ;`);
    console.log('Columnas verificadas en usuario.');
