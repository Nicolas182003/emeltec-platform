      ...
      @if (loading() && !siteContext()) {
        ...
        <div class="mx-auto max-w-[1360px] space-y-3">
          ...
          <section class="grid grid-cols-2 gap-2 xl:grid-cols-4">
            <article class="rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-center shadow-sm">
              <p class="text-[9px] font-black uppercase tracking-[0.2em] text-emerald-600">Enviados</p>
              <p class="mt-0.5 text-2xl font-black leading-none text-emerald-600">622</p>
              <p class="mt-0.5 text-[10px] font-semibold text-emerald-500">registros exitosos</p>
            </article>

            <article class="rounded-lg border border-slate-200 bg-white px-3 py-2 text-center shadow-sm">
              <p class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Último envío</p>
              <p class="mt-0.5 text-sm font-black leading-none text-slate-800">26 abr 2026</p>
              <p class="mt-0.5 text-[10px] font-semibold text-slate-500">21:00</p>
            </article>

            <article class="rounded-lg border border-slate-200 bg-white px-3 py-2 text-center shadow-sm">
              <p class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Tasa de éxito</p>
              <p class="mt-0.5 text-2xl font-black leading-none text-slate-800">100%</p>
            </article>

            <article class="rounded-lg border border-rose-200 bg-rose-50 px-3 py-2 text-center shadow-sm">
              <p class="text-[9px] font-black uppercase tracking-[0.2em] text-rose-400">Rechazados</p>
              <p class="mt-0.5 text-2xl font-black leading-none text-rose-500">0</p>
              <p class="mt-0.5 text-[10px] font-semibold text-rose-400">por la DGA</p>
            </article>
          </section>
          ...
          <section class="grid grid-cols-1 gap-3 xl:grid-cols-[520px_minmax(0,1fr)]">
            <article class="rounded-xl border border-cyan-200 bg-white p-3 shadow-[0_0_0_1px_rgba(8,145,178,0.04),0_12px_30px_rgba(15,23,42,0.06)]">
              ...
              <div class="flex items-stretch gap-5">
                <div class="relative min-h-[280px] flex-1 overflow-hidden rounded-lg border border-slate-100 bg-[#eee7d8]">
                  <!-- Textura de tierra -->
                  ...
                  <!-- ── SUPERFICIE: tierra café con pasto ── -->
                  <!-- Franja de tierra café sobre la boca del pozo -->
                  <div class="absolute left-0 right-0 top-0 h-8 bg-[#c8a87a] opacity-60"></div>
                  <!-- Pasto saliendo de la tierra (coordenadas fuera del pozo: izq < 115px, der > 258px) -->
                  <svg class="absolute top-0 left-0 w-full" height="32" style="overflow:visible">
                    <g stroke="#6B9B37" stroke-width="1.5" stroke-linecap="round">
                      <line x1="20"  y1="32" x2="17"  y2="24"/>
                      <line x1="35"  y1="32" x2="32"  y2="23"/>
                      <line x1="52"  y1="32" x2="49"  y2="25"/>
                      <line x1="68"  y1="32" x2="65"  y2="22"/>
                      <line x1="84"  y1="32" x2="81"  y2="24"/>
                      <line x1="100" y1="32" x2="97"  y2="25"/>
                      <line x1="260" y1="32" x2="257" y2="24"/>
                      <line x1="278" y1="32" x2="275" y2="23"/>
                      <line x1="295" y1="32" x2="292" y2="25"/>
                      <line x1="312" y1="32" x2="309" y2="22"/>
                      <line x1="330" y1="32" x2="327" y2="24"/>
                    </g>
                  </svg>
                  <!-- Línea horizontal de superficie sobre la boca del pozo -->
                  <div class="absolute left-0 right-0 border-t-[3px] border-[#8B7355]" style="top: 32px;"></div>
                  <!-- Label "Superficie" sobre la línea de tierra -->
                  <div class="absolute left-3 text-[9px] font-bold text-white" style="top: 4px; text-shadow: 0 1px 2px rgba(0,0,0,0.3);">Superficie</div>

                  <!-- Paredes del pozo -->
                  <div class="absolute bottom-0 left-[38%] top-8 w-[112px] border-x-4 border-slate-500 bg-white/80"></div>
                  <!-- Columna de agua -->
                  ...
                  <div class="absolute left-[16%] w-[215px] border-t-2 border-dashed border-cyan-600" style="top: 112px;"></div>
                  <div class="absolute left-4 text-[9px] font-black leading-tight text-cyan-700" style="top: 98px;">Nivel<br>Freático</div>

                  <!-- Sensor -->
                  <div class="absolute right-4 flex items-center gap-1 text-[9px] font-bold text-orange-500" style="bottom: 28px;">
                    <span class="h-2.5 w-2.5 rounded-sm bg-orange-500"></span>
                    Sensor
                  </div>
                </div>

                <div class="w-[128px] shrink-0 space-y-3">
          ...
          <section class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 px-4 py-2.5">
              <div>
                <h2 class="text-sm font-black text-slate-800">Detalle de Registros Reportados</h2>
                <p class="mt-0.5 text-[10px] font-semibold text-slate-400">720 registros en el periodo</p>
              </div>
              <div class="flex flex-wrap items-center gap-1.5 text-[11px] font-bold">
                <span class="text-slate-400">Desde</span>
                <span class="inline-flex h-7 items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-2.5 text-slate-600">
